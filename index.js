...
export default {
  install(Vue, config) {
    ...
    Vue.component('baidu-map', BaiduMap)  // 已支持
    Vue.component('bm-view', BmView)

    Vue.component('bm-scale', BmScale)  // 已支持
    Vue.component('bm-navigation', BmNavigation)
    Vue.component('bm-map-type', BmMapType)
    Vue.component('bm-overview-map', BmOverviewMap) // 已支持
    Vue.component('bm-geolocation', BmGeolocation)  // 已支持
    Vue.component('bm-copyright', BmCopyright)  // 已支持
    Vue.component('bm-city-list', BmCityList)
    Vue.component('bm-panorama', BmPanorama)
    Vue.component('bm-control', BmControl)  // 已支持

    Vue.component('bm-marker', BmMarker) // 已支持
    ...
    Vue.component('bm-info-window', BmInfoWindow) // 已支持
